...
var uri = "mongodb://root:rootpassword@localhost:27017";
...
var UserDAO = /** @class */ (function () {
    ...
    UserDAO.prototype.addCode = function (aud) {
    ...
    UserDAO.prototype.checkCode = function (aud) {
        return __awaiter(this, void 0, void 0, function () {
            var prom;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.coll.find({ code: aud.hashcode }).toArray()];
                    case 1:
                        prom = _a.sent();
                        if (prom.length)
                            return [2 /*return*/, prom[0].output];
